...
│   │   └── helix/          # Protocole : modes, USB, paquets ; `live_write.rs` = construction trames write live expérimentales
...
| `write_live_param` | Write live USB propriétaire (voir **26 avril 2026 (fin de soirée)** ; garde `symbolicId == "Gain"`, test `forcedRaw=1.0` jusqu’à généralisation). |
